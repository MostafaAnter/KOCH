...
public class ClientProfileActivity extends LocalizationActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.client_profile, menu);
        return true;
    }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ClientDataFragment(), getString(R.string.info));
        adapter.addFragment(new ClientChatsFragment(), getString(R.string.chats));
        adapter.addFragment(new ClientRequestFragment(), getString(R.string.requests));
